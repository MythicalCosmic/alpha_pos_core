...
SYNC_ORDER = [
    ...
    'purchasereceiving', 'purchasereceivingcorrection', 'stocklevel',
...
MODEL_MAP = {
    ...
    'purchasereceivingcorrection': 'stock.PurchaseReceivingCorrection',
    ...
    'stockadjustmentrequest': 'stock.StockAdjustmentRequest',
    ...
    'attendanceadjustmentrequest': 'hr.AttendanceAdjustmentRequest',
    'attendanceexcuse': 'hr.AttendanceExcuse',
...
FK_UUID_MAPPINGS = {
    ...
    'over_receipt_approved_by_uuid': ('base', 'User', 'over_receipt_approved_by'),
    'reviewed_by_uuid': ('base', 'User', 'reviewed_by'),
