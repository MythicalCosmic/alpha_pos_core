PERMISSIONS = [
    ...
    ('stock.inventory_control.view', 'View inventory control values', 'Money control'),
    ...
    ('expense.request.void', 'Void paid expense requests', 'Expense request approvals'),
    ('expense.direct.pay', 'Use the legacy direct expense adapter', 'Expense request approvals'),
    ('expense.category.view', 'View expense categories', 'Expense requests'),
    ('expense.category.manage', 'Manage expense categories', 'Expense request approvals'),

    ('money.control.view', 'View consolidated money control', 'Money control'),
    ('money.control.reconcile', 'View money reconciliation evidence', 'Money control'),
    ('treasury.account.view', 'View Treasury accounts and history', 'Money control'),
    ('treasury.transfer', 'Transfer money between Treasury accounts', 'Money control'),
